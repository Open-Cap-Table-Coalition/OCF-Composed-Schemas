...
- Deprecated compatibility wrapper for `EquityCompensationRelease`; the inherited mapping routes RSU releases to Carta settlement objects and leaves option/SAR variants without a release target.
