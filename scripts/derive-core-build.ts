 ...
 * It ALSO regenerates the source-side analysis docs (docs/core-lossy-inventory,
 * -unmapped-inventory) so one `core:build` refreshes every Core-specific artifact. The
 * target-first inverse report and visual gallery are generated by `mapping:artifacts`.
 *
...
async function main(argv: { base: string; sample: string }): Promise<number> {
  ...
  // Source-side analysis docs — regenerated here so Core-specific loss inventories
  // remain synchronized with the Core derivation.
