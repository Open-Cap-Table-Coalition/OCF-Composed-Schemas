...
export function renderMappingExplorerCss(): string {
  return [
    ...
    ".direction-tabs { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1px; margin: 0 0 18px; padding: 1px; background: var(--line); } .direction-tab { display: grid; gap: 5px; border: 0; padding: 18px 20px; background: var(--panel); color: var(--muted); text-align: left; cursor: pointer; } .direction-tab:hover { color: var(--ink); } .direction-tab.is-active { background: var(--mint); color: #08131c; } .direction-tab-kicker { font-size: 10px; font-weight: 800; letter-spacing: .14em; text-transform: uppercase; } .direction-tab strong { font-size: 18px; font-weight: 750; letter-spacing: -.03em; }",
    ...
    ".direction-tabs { background: #f1f1ff; } .direction-tab { background: #fff; color: var(--muted); } .direction-tab.is-active { background: var(--primary); color: #fff; } .direction-tab:hover { color: var(--primary); } .direction-tab.is-active:hover { color: #fff; }",
