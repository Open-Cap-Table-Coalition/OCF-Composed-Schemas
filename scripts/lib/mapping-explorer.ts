...
function cartaSchemaPanel(data: MappingExplorerData): string {
  ...
  const reports = resources.reports
    ...
    .join("");
  return `<section id="carta-core" class="map-guide schema-source-panel" aria-labelledby="carta-core-title"><div class="map-guide-heading"><span class="eyebrow">Schema source</span><h2 id="carta-core-title">Carta OCF Core proposal</h2><p>Browse the current Carta schema bundle tracked in <code>${html(
