...
export function renderMappingExplorerCss(): string {
  return [
    ...
    '.proposal-banner { margin: 0 calc(50% - 50vw); padding: 38px max(20px, calc((100vw - 1024px) / 2)); border: 0; border-top: 1px solid rgba(255,255,255,.28); border-bottom: 1px solid rgba(255,255,255,.28); background: var(--primary); color: #fff; box-shadow: none; } .proposal-banner .eyebrow { color: rgba(255,255,255,.72); } .proposal-banner h2 { color: #fff; font-family: "Gotham", "Helvetica Neue", Arial, sans-serif; font-weight: 400; letter-spacing: .08em; text-transform: uppercase; } .proposal-banner p { color: rgba(255,255,255,.84); } .proposal-banner .mini-chip { background: transparent; color: rgba(255,255,255,.9); border-color: rgba(255,255,255,.38); } .proposal-banner .button-primary { background: #fff; color: var(--primary); border-color: #fff; } .proposal-banner .button-primary:hover { background: #f1f1ff; border-color: #f1f1ff; } .proposal-banner .button-quiet { background: transparent; color: #fff; border-color: rgba(255,255,255,.72); } .proposal-banner .button-quiet:hover { background: #fff; color: var(--primary); border-color: #fff; } .map-guide { background: #f1f1ff; border-color: rgba(42,48,200,.22); } .map-guide-heading h2 { color: var(--ink); } .map-guide-heading p { color: var(--muted); } .map-guide-step { background: #fff; border-color: var(--line); } .map-guide-number { background: var(--primary); color: #fff; } .map-guide-step strong { color: var(--ink); } .map-guide-step div > span { color: var(--muted); }',
