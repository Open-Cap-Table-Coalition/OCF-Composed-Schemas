...
export function renderGapReport(d: Derived): string {
  ...
  lines.push(
    ...
    `3. **${story.nonEntityObjectDefs}** object-shaped support definitions (**${roleCounts["nested-obj"]}** nested objects + **${roleCounts["value-type"]}** object-shaped value type) plus **${story.scalarValueTypeDefs}** scalar support types are packaging pieces, not standalone objects.`,
